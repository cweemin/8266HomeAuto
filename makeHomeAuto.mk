...
LIBS ?= $(ESP_LIBS)/Wire \
        ...
        $(ESP_LIBS)/Ticker \
        $(ESP_LIBS)/ArduinoOTA \
        $(HOME)/Arduino/libraries/Arduino-LiquidCrystal-I2C-library \
        $(HOME)/Arduino/libraries/Timezone \
        $(HOME)/Arduino/libraries/Time \
...
ESPOTA_TOOL = $(TOOLS_ROOT)/espota.py


INCLUDE_DIRS += $(SDK_ROOT)/include $(CORE_DIR) $(ESP_ROOT)/variants/generic $(OBJ_DIR)
C_DEFINES = -D__ets__ -DICACHE_FLASH -U__STRICT_ANSI__ -DF_CPU=160000000L -DARDUINO=10605 -DARDUINO_ESP8266_ESP01 -DARDUINO_ARCH_ESP8266 -DESP8266
...
ota: all
	$(ESPOTA_TOOL) --ip=$(OTA_IP) --progress --file=$(MAIN_EXE)
